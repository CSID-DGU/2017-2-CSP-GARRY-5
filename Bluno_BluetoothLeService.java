 ...
 */
public class Bluno_BluetoothLeService extends Service {
    private final static String TAG = Bluno_BluetoothLeService.class.getSimpleName();
    ...
    //ring buffer
    private Bluno_RingBuffer<BluetoothGattCharacteristicHelper> mCharacteristicRingBuffer = new Bluno_RingBuffer<BluetoothGattCharacteristicHelper>(8);
...
//        }
    ...
    public class LocalBinder extends Binder {
        Bluno_BluetoothLeService getService() {
            return Bluno_BluetoothLeService.this;
        }
    }
