...
import org.androidtown.sw_pj.decorators.EventDecorator;
import org.androidtown.sw_pj.decorators.OneDayDecorator;
import org.androidtown.sw_pj.decorators.SaturdayDecorator;
import org.androidtown.sw_pj.decorators.SundayDecorator;
   ...
   // String phonenumber=((ProfileActivity)ProfileActivity.mContext).loadPreference( "phonenumber" );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        materialCalendarView.setOnDateChangedListener(new OnDateSelectedListener() {
            ...
            public void onDateSelected(@NonNull MaterialCalendarView widget, @NonNull CalendarDay date, boolean selected) {
                ...
                count_pee = ((MainActivity)MainActivity.mContext).loadPreference2(key_pee);
                count_shit = ((MainActivity)MainActivity.mContext).loadPreference2(key_shit);
                ...
                button2.setOnClickListener( new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        String phonenumber = ((ProfileActivity)ProfileActivity.mContext2).loadPreference( "phonenumber" );
                        String date = the_day;
    ...
    private class ApiSimulator extends AsyncTask<Void, Void, List<CalendarDay>> {
        ...
        protected void onPostExecute(@NonNull List<CalendarDay> calendarDays) {
            ...
            materialCalendarView.addDecorator(new EventDecorator(Color.GREEN, calendarDays,CheckActivity.this));
        }
    }
